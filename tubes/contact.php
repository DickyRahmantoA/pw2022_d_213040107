...
<nav class="navbar navbar-expand-lg navbar-dark shadow" style="background-color: #b1cba6;">
  <div class="container">
    ...
    <div class="container" style="max-width: 600px;">
      <h1 style="text-align: center;" class="mt-5">Hubungi Kami Bisa</h1>
      <h2 style="text-align: center;" class="mb-4">Melewati Berbagai Macam Platform</h2>
      <div class="row">
        <div class="col-md-4 text-center">
         <a href=""><img src="https://img.icons8.com/color/96/undefined/whatsapp--v1.png"/></a>
         <p style="text-align: center;"><a href="" style="text-decoration: none;" class="text-dark">Whatsapp</a></p>
        </div>
        <div class="col-md-4 text-center">
         <a href=""><img src="https://img.icons8.com/cute-clipart/96/undefined/instagram-new.png"/></a>
         <p style="text-align: center;"><a href="" style="text-decoration: none;" class="text-dark">Instagram</a></p>
        </div>
        <div class="col-md-4 text-center">
         <a href=""><img src="https://img.icons8.com/color/96/undefined/twitter--v1.png"/></a>
         <p style="text-align: center;"><a href="" style="text-decoration: none;" class="text-dark">Twitter</a></p>
        </div>
        <div class="col-md-4 text-center">
         <a href=""><img src="https://img.icons8.com/color/96/undefined/facebook--v1.png"/></a>
         <p style="text-align: center;"><a href="" style="text-decoration: none;" class="text-dark">Facebook</a></p>
        </div>
        <div class="col-md-4 text-center">
         <a href=""><img src="https://img.icons8.com/color/96/undefined/youtube--v1.png"/></a>
         <p style="text-align: center;"><a href="" style="text-decoration: none;" class="text-dark">Youtube</a></p>
        </div>
        <div class="col-md-4 text-center">
         <a href=""><img src="https://img.icons8.com/color/96/undefined/google-plus--v1.png"/></a>
         <p style="text-align: center;"><a href="" style="text-decoration: none;" class="text-dark">Google Plus</a></p>
        </div>
